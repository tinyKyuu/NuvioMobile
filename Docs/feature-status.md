...
| Completed-download presentation, adaptive manager surfaces, theme-safe selection and focus treatment, state restoration, and accessibility hardening | Fork addition | iOS, iPadOS, and Android shared source | In review | No equivalent found at the reviewed base | [PR #30](https://github.com/tinyKyuu/NuvioMobile/pull/30); 57 focused Android tests, 1,102 Android-host tests, both Android debug variants, Kotlin/Native iOS simulator test compilation, an unsigned iOS simulator build, iPhone and iPad simulators, and Android phone, tablet-sized, and narrow emulator windows passed. Physical-device QA remains deferred; F08C artwork repair remains separate. |
