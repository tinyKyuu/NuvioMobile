...
| Library-first completed-download catalog and manager, separate transfer activity and policy destinations, exact episode removal, and structured partial-failure cleanup | Fork addition | iOS, iPadOS, and Android shared source | In review | No equivalent found at the reviewed base | [F08A review evidence](../F08-REVIEW.md); no schema migration or version change. Failed cleanup targets remain cataloged and selected, while successful IDs and reclaimed bytes are reported separately. F08B visual hardening and F08C artwork repair remain deferred. |
